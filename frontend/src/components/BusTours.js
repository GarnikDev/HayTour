...
export default function BusTours() {
    ...
    const stops = ["Pickup", "Charents Arch", "Garni Temple", "Geghard Monastery", "Symphony of Stones"];

    return (
        <Box sx={{ flexGrow: 1, pb: 10 }}>
            <Box sx={{ bgcolor: 'var(--primary-color)', color: 'white', py: 6, textAlign: 'center' }}>
                <Typography variant="h3" sx={{ fontWeight: 800 }}>Garni & Geghard Express</Typography>
                <Typography variant="subtitle1">Day Trip via Climate-Controlled Coach</Typography>
            </Box>

            <Container sx={{ mt: -4 }}>
                <Paper elevation={4} sx={{ height: '500px', borderRadius: '15px', backgroundImage: 'url("https://images.unsplash.com/photo-1590011915431-77038e1217e9?q=80&w=1470")', backgroundSize: 'cover', backgroundPosition: 'center' }} />
            </Container>

            <Container sx={{ mt: 8 }}>
                <Grid container spacing={6} sx={{ mb: 8 }}>
                    <Grid item xs={12} md={4.5}>
                        <Typography variant="h5" gutterBottom sx={{ fontWeight: 'bold' }}>Tour Highlights</Typography>
                        <List>{stops.map((stop, i) => (<ListItem key={i} sx={{ px: 0 }}><ListItemIcon><DirectionsBusIcon color="primary" /></ListItemIcon><ListItemText primary={stop} /></ListItem>))}</List>
                    </Grid>
                    <Grid item xs={12} md={7.5}>
                        <Typography variant="h5" gutterBottom sx={{ fontWeight: 'bold' }}>Expedition Map</Typography>
                        <Paper elevation={1} sx={{ height: '400px', borderRadius: '12px', overflow: 'hidden', border: '1px solid #eee' }}>
                            <iframe title="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d48777.24838424172!2d44.7865261!3d40.1738739!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x406ab122045e053f%3A0xc3f173816694e99a!2sGarni%20Temple!5e0!3m2!1sen!2s!4v1710000000000!5m2!1sen!2s" width="100%" height="100%" style={{ border: 0 }}></iframe>
                        </Paper>
                    </Grid>
                </Grid>
