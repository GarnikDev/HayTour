...
export default function WalkingTours() {
    ...
    const stops = ["Republic Square", "The Blue Mosque", "Kond Historical District", "Saryan Street Hub", "The Cascade Complex"];
    ...
    return (
        <Box sx={{ flexGrow: 1, pb: 10 }}>
            <Box sx={{ bgcolor: 'var(--primary-color)', color: 'white', py: 6, textAlign: 'center' }}>
                ...
                <Typography variant="subtitle1">Exploring the Soul of Yerevan on Foot</Typography>
            </Box>

            <Container sx={{ mt: -4 }}>
                <Paper elevation={4} sx={{ height: '500px', borderRadius: '15px', backgroundImage: 'url("https://images.unsplash.com/photo-1544919101-903965582f3c?q=80&w=1470")', backgroundSize: 'cover', backgroundPosition: 'center' }} />
            </Container>

            <Container sx={{ mt: 8 }}>
                <Grid container spacing={6} sx={{ mb: 8 }}>
                    <Grid item xs={12} md={4.5}>
                        <Typography variant="h5" gutterBottom sx={{ fontWeight: 'bold' }}>Tour Route & Stops</Typography>
                        <List>{stops.map((stop, i) => (<ListItem key={i} sx={{ px: 0 }}><ListItemIcon><LocationOnIcon color="primary" /></ListItemIcon><ListItemText primary={stop} /></ListItem>))}</List>
                    </Grid>
                    <Grid item xs={12} md={7.5}>
                        <Typography variant="h5" gutterBottom sx={{ fontWeight: 'bold' }}>Route Map</Typography>
                        <Paper elevation={1} sx={{ height: '400px', borderRadius: '12px', overflow: 'hidden', border: '1px solid #eee' }}>
                            <iframe title="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12192.515201886866!2d44.50379873993351!3d40.18398864704702!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x406abcf9a3e20e33%3A0x6b9d623277028131!2sRepublic%20Square%2C%20Yerevan!5e0!3m2!1sen!2sam!4v1700000000000!5m2!1sen!2sam" width="100%" height="100%" style={{ border: 0 }}></iframe>
                        </Paper>
                    </Grid>
                </Grid>
